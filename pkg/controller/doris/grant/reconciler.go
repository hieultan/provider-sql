...
func (c *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	username, host := doris.SplitUserHost(*cr.Spec.ForProvider.User)
...
func defaultIdentifier(identifier *string) string {
	if identifier != nil && *identifier != "*" {
		return doris.QuoteIdentifier(*identifier)
	}
...
func (c *external) parseGrantRows(ctx context.Context, username, host, dbname, table string) ([]string, error) {
	query := fmt.Sprintf("SHOW GRANTS FOR %s@%s", doris.QuoteValue(username), doris.QuoteValue(host))
...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	if err := doris.ExecWrapper(ctx, c.db, doris.ExecQuery{Query: query, ErrorValue: errCreateGrant}); err != nil {
...
func (c *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	...
	if len(toRevoke) > 0 {
		...
		if err := doris.ExecWrapper(ctx, c.db,
			doris.ExecQuery{
...
func (c *external) Delete(ctx context.Context, mg resource.Managed) error {
	...
	if err := doris.ExecWrapper(ctx, c.db, doris.ExecQuery{Query: query, ErrorValue: errRevokeGrant}); err != nil {
		var myErr *mysqldriver.MySQLError
		if errors.As(err, &myErr) && myErr.Number == errCodeNoSuchGrant {
