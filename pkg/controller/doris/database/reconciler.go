...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	return &external{db: c.newDB(s.Data, tlsName)}, nil
}
...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	query := "CREATE DATABASE " + doris.QuoteIdentifier(meta.GetExternalName(cr))

	if err := doris.ExecWrapper(ctx, c.db, doris.ExecQuery{Query: query, ErrorValue: errCreateDB}); err != nil {
...
func (c *external) Delete(ctx context.Context, mg resource.Managed) error {
	...
	query := "DROP DATABASE IF EXISTS " + doris.QuoteIdentifier(meta.GetExternalName(cr))

	if err := doris.ExecWrapper(ctx, c.db, doris.ExecQuery{Query: query, ErrorValue: errDropDB}); err != nil {
		return err
	}
