...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PublicationPublish) DeepCopyInto(out *PublicationPublish) {
	*out = *in
	if in.Insert != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PublicationPublish.
func (in *PublicationPublish) DeepCopy() *PublicationPublish {
	if in == nil {
		return nil
	}
	out := new(PublicationPublish)
