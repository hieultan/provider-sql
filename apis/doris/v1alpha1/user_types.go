...
// UserParameters define the desired state of a Doris user instance.
type UserParameters struct {
	...
	// See https://doris.apache.org/docs for details
	// +optional
...
// A UserObservation represents the observed state of a Doris user.
...
// A User represents the declarative state of a Doris user.
